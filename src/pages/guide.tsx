...
export default function Guide() {
  ...
  return (
    <>
      <div className="fixed top-20 left-1/2 -translate-x-1/2 z-50 w-full max-w-3xl px-4 sm:px-6 pointer-events-none">
        <div className="bg-[rgba(6,10,18,0.88)] backdrop-blur-xl border border-white/8 rounded-2xl px-4 py-3 shadow-[0_8px_30px_rgba(0,0,0,0.35)]">
